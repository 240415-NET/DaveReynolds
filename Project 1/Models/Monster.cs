...
public class Monster : Item
{
    ...
    public override string ToString()
    {
        ...
        return String.Format("Owner: {0,-10}|Card #: {1,7}|Type: {2,-13}|Card Name:{3, -10} |Art Type: {4,-10}|Element: {5, -10}|Value: {6, -5:C2}|Rarity: {7,-6}", owner, cardId, cardType, name, artType, elementalType, value, rarity);
    }
}