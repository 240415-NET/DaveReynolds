namespace classBasics
{
    public class App
    {
        ...
        // UI class
        //this class is repsonsible for taking in  an aninmal type object and printing out the animal stats it recieves from teh object
        //because we are using the parent datatype, we can only assing objects that are of the parent type or children of the parent
        //this is an combination of Inheritance and Polymorphins(constructor overload and data type overloading)
